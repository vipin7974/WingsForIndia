  ...
  return (
    <Box flexGrow={1} className="main-div">
      <Grid container sx={{ height: '100vh', overflow: 'hidden' }}>
        <Grid size={{ xs: 12, sm: 12, md: 6, lg: 6, xl: 6 }} className='side-division' flexDirection={'column'}>
          <div className='side-heading'>
            Medical Crowdfunding is the Best Way to Raise Money for Medical Expenses
          </div>
          <button type="button" class="button-gradient-btn  main-btn button-gradient-gradient">
            Donate Now
          </button>
        </Grid>
